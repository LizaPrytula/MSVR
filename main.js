...
function draw() {
  ...
  // gl.uniformMatrix4fv(shProgram.iModelViewProjectionMatrix, false, m4.multiply((virtualCam.mProjectionMatrix, m4.multiply(m4.translation(tSS[0], tSS[1], tSS[2]), modelViewProjection))));
  // gl.uniformMatrix4fv(shProgram.iModelViewProjectionMatrix, false, m4.multiply((virtualCam.mProjectionMatrix, m4.multiply(m4.translation(0, 0, 0), matAccum2))));
